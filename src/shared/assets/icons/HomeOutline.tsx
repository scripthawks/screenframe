...
const HomeOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    fill={'none'}
    height={24}
    ref={ref}
    ...
    {...props}
  >
    <g clipPath={'url(#HomeOutline_svg__a)'}>
      <path
        d={
    ...
    <defs>
      <clipPath id={'HomeOutline_svg__a'}>
        <path d={'M0 0h24v24H0z'} fill={'currentColor'} />
      </clipPath>
    </defs>
  </svg>
)
const ForwardRef = forwardRef(HomeOutline)

...
const EmailOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath={'url(#EmailOutline_svg__a)'}>
      <path
        fill={'currentColor'}
        d={
    ...
    <defs>
      <clipPath id={'EmailOutline_svg__a'}>
        <path fill={'currentColor'} d={'M0 0h24v24H0z'} />
      </clipPath>
    </defs>
  </svg>
)
const ForwardRef = forwardRef(EmailOutline)

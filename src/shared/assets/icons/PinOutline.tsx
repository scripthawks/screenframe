...
const PinOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill={'currentColor'} clipPath={'url(#PinOutline_svg__a)'}>
      <path
        d={
...
const ForwardRef = forwardRef(PinOutline)

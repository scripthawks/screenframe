...
const LogOutOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill={'currentColor'} clipPath={'url(#LogOutOutline_svg__a)'}>
      <path
        d={
    ...
    <defs>
      <clipPath id={'LogOutOutline_svg__a'}>
        <path fill={'currentColor'} d={'M0 0h24v24H0z'} />
      </clipPath>
    </defs>
  </svg>
)
const ForwardRef = forwardRef(LogOutOutline)

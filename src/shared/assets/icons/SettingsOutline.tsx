...
const SettingsOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    fill={'none'}
    height={24}
    ref={ref}
    ...
    {...props}
  >
    <g clipPath={'url(#SettingsOutline_svg__a)'} fill={'currentColor'}>
      <path
        d={
    ...
    <defs>
      <clipPath id={'SettingsOutline_svg__a'}>

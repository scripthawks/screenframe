...
const FlagUnitedKingdom = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    fill={'none'}
    height={24}
    ref={ref}
    ...
    {...props}
  >
    <path d={'M0 0h24v24H0z'} fill={'url(#FlagUnitedKingdom_svg__a)'} />
    <defs>
      <pattern
        height={1}
        id={'FlagUnitedKingdom_svg__a'}
        patternContentUnits={'objectBoundingBox'}
        width={1}
      >
        <use transform={'scale(.01389)'} xlinkHref={'#FlagUnitedKingdom_svg__b'} />
      </pattern>
      <image
        height={72}
        id={'FlagUnitedKingdom_svg__b'}
...
const ForwardRef = forwardRef(FlagUnitedKingdom)

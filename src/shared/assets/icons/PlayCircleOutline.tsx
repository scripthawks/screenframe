...
const PlayCircleOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill={'currentColor'} clipPath={'url(#PlayCircleOutline_svg__a)'}>
    ...
    <defs>
      <clipPath id={'PlayCircleOutline_svg__a'}>

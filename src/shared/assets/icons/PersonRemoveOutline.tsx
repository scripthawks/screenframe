...
const PersonRemoveOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    fill={'none'}
    height={24}
    ref={ref}
    ...
    {...props}
  >
    <g clipPath={'url(#PersonRemoveOutline_svg__a)'} fill={'currentColor'}>
      <path
        d={
    ...
    <defs>
      <clipPath id={'PersonRemoveOutline_svg__a'}>
        <path d={'M0 0h24v24H0z'} fill={'currentColor'} />
      </clipPath>
    </defs>
  </svg>
)
const ForwardRef = forwardRef(PersonRemoveOutline)
